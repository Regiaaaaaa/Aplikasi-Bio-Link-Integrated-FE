...
import { ArrowLeft, Save, Plus, Trash2, Eye, EyeOff, GripVertical, Loader2, Edit2, X, Check, Upload, Image as ImageIcon, Palette } from 'lucide-react';
      ...
      <Layout>
        <div className="flex items-center justify-center min-h-screen bg-gray-50 px-4">
          <div className="text-center bg-white rounded-xl shadow-sm border border-red-100 p-8 max-w-md w-full">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Error Loading Bundle</h3>
    ...
    <Layout>
      ...
      {showToast && (
        <div className={`toast-notification ${!showToast ? 'hiding' : ''}`}>
          <div className={`flex items-center gap-3 p-4 rounded-lg shadow-lg border-l-4 ${
            toastType === 'success' 
      ...
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
                ...
                <div className="border-l border-gray-300 pl-2 sm:pl-4 min-w-0">
                  <h1 className="text-base sm:text-xl font-bold text-gray-900 truncate">{bundle?.name}</h1>
                  <p className="text-xs sm:text-sm text-gray-500 font-mono truncate">/{bundle?.slug}</p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-[1600px]">
          <div className={`grid grid-cols-1 xl:grid-cols-12 gap-4 sm:gap-6 ${!showPreview ? 'mobile-hide-preview' : ''}`}>
            ...
            <div className="xl:col-span-3 space-y-4 sm:space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mobile-section xl:sticky xl:top-24">
                <div className="flex items-center gap-2 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-base sm:text-lg font-semibold text-gray-900">Choose Theme</h2>
                </div>
                ...
                {loadingThemes ? (
                  <div className="text-center py-6 sm:py-8">
                    ...
                    <p className="mt-2 text-xs sm:text-sm text-gray-500">Loading themes...</p>
                  </div>
                ) : (
            ...
            <div className="xl:col-span-6 space-y-4 sm:space-y-6">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mobile-section">
                <h2 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-900">Bundle Information</h2>
                <div className="space-y-3 sm:space-y-4">
                      ...
                      <div className="relative flex-shrink-0">
                        {profileImagePreview ? (
                          ...
                          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gray-100 flex items-center justify-center border-4 border-gray-200">
                            <ImageIcon size={24} className="text-gray-400 sm:w-8 sm:h-8" />
                          </div>
                        )}
                      </div>
                      <div className="flex-1 min-w-0">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-all text-sm sm:text-base"
                    />
                  </div>
                </div>
              </div>
              ...
              {/* Custom Links */}
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mobile-section">
                <h2 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-900">Custom Links</h2>
                
                {/* Add New Link Form */}
                <form onSubmit={handleAddLink} className="mb-3 sm:mb-4 p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="space-y-2 sm:space-y-3">
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all text-sm sm:text-base"
                    />
                    <input
                      type="url"
                ...
                <div className="space-y-2">
                  {links.length === 0 ? (
                    <p className="text-center text-gray-500 py-3 sm:py-4 text-xs sm:text-sm">No links yet. Add your first link above!</p>
                  ) : (
                    links.map((link) => (
                      <div
                        key={link.id}
                      ...
                      >
                        <GripVertical size={16} className="text-gray-400 cursor-move flex-shrink-0 sm:w-[18px] sm:h-[18px]" />
                        ...
                        {editingLinkId === link.id ? (
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-medium text-gray-900 text-xs sm:text-sm truncate">{link.name}</p>
                            <p className="text-[10px] sm:text-xs text-gray-500 truncate">{link.url}</p>
                          </div>
                        )}
              ...
              {/* Social Media Links */}
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mobile-section">
                <h2 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-900">Social Media Links</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setBundleForm({ ...bundleForm, instagram_url: e.target.value })}
                      placeholder="https://instagram.com/username"
                      className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all text-sm sm:text-base"
                    />
                  </div>
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">GitHub</label>
                    <input
                      type="url"
                      value={bundleForm.github_url}
                      onChange={(e) => setBundleForm({ ...bundleForm, github_url: e.target.value })}
                      placeholder="https://github.com/username"
                      className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all text-sm sm:text-base"
                    />
                  </div>
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">TikTok</label>
                    <input
                      type="url"
                      value={bundleForm.tiktok_url}
                      onChange={(e) => setBundleForm({ ...bundleForm, tiktok_url: e.target.value })}
                      placeholder="https://tiktok.com/@username"
                      className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all text-sm sm:text-base"
                    />
                  </div>
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">YouTube</label>
                    <input
                      type="url"
                      value={bundleForm.youtube_url}
                      onChange={(e) => setBundleForm({ ...bundleForm, youtube_url: e.target.value })}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setBundleForm({ ...bundleForm, facebook_url: e.target.value })}
                      placeholder="https://facebook.com/username"
                      className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all text-sm sm:text-base"
                    />
                  </div>
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">X (Twitter)</label>
                    <input
                      type="url"
                      value={bundleForm.x_url}
                      onChange={(e) => setBundleForm({ ...bundleForm, x_url: e.target.value })}
                ...
                <div className="xl:sticky xl:top-24">
                  <div className="text-center mb-2 sm:mb-3">
                    ...
                    <p className="text-[10px] sm:text-xs text-gray-500 mt-1.5 sm:mt-2 font-medium">
                      {getSelectedTheme()?.name || bundle?.theme?.name || 'Default'}
                    </p>
                  </div>
                  ...
                  <div className="iphone-mockup-compact">
                    <div className="iphone-frame-compact">
                      ...
                      <div className="iphone-screen-compact">
                        <div 
                          data-theme={getSelectedTheme()?.name || bundle?.theme?.name || 'light'}
                          ...
                          <div className="p-4 sm:p-6 text-center min-h-full">
                            ...
                            <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-2 sm:mb-3 mt-4 sm:mt-6">
                              {profileImagePreview ? (
                                ...
                                <div className="w-full h-full bg-base-300 rounded-full flex items-center justify-center border-2 border-base-200">
                                  <ImageIcon size={18} className="text-base-content/30 sm:w-5 sm:h-5" />
                                </div>
                              )}
                            </div>
                            ...
                            <div className="flex gap-1 sm:gap-1.5 justify-center mb-3 sm:mb-4 flex-wrap px-2">
                              {bundleForm.instagram_url && (
                                ...
                                >
                                  <svg xmlns="http://www.w3.org/2000/svg" className="h-2.5 w-2.5 sm:h-3 sm:w-3" fill="currentColor" viewBox="0 0 24 24">
