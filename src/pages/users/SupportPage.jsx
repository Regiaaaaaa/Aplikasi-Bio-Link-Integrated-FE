...
const faqsData = [
    {
        ...
        question: 'Apakah saya bisa menyesuaikan warna atau font di luar tema yang sudah disediakan?',
        answer: 'Saat ini, kustomisasi tampilan Bundle hanya tersedia melalui tema-tema siap pakai yang kami sediakan. Fitur penyesuaian warna (color palette) atau font kustom belum tersedia.',
    },
    {
        id: 2,
        icon: '💎',
        category: 'Premium',
        question: 'Apakah Synapse memiliki rencana untuk menawarkan fitur Premium atau berbayar di masa depan?',
        answer: 'Ya. Aplikasi ini saat ini masih dalam tahap pengembangan. Kami berencana untuk menawarkan fitur-fitur tambahan yang lebih canggih (Premium) di masa mendatang untuk pengguna yang membutuhkan analitik mendalam atau integrasi bisnis.',
    },
    {
        id: 3,
        icon: '📊',
        category: 'Analytics',
        question: 'Bagaimana cara mengetahui berapa kali Bundle saya dilihat dan diakses oleh orang lain?',
        answer: 'Anda dapat memantau performa Bundle Anda di dashboard utama. Sistem kami mencatat semua interaksi ke dalam logs_bundle dan logs_links, sehingga Anda dapat melihat secara detail jumlah views (dilihat) dan clicks (diklik) dari setiap tautan.',
    },
    {
        id: 4,
        icon: '🚀',
        category: 'Getting Started',
        question: 'Bagaimana langkah-langkah untuk membuat Bundle (halaman Link-in-Bio) baru?',
        answer: 'Prosesnya mudah! Anda hanya perlu klik menu "My Page" atau "Bundles". Dari sana, Anda akan diarahkan untuk memilih tema yang diinginkan, dan setelah itu, Anda dapat mulai mengisi tautan media sosial dan custom link Anda sendiri.',
    },
    {
        id: 5,
        icon: '🔒',
        category: 'Privacy',
        question: 'Apakah saya bisa mengatur Bundle saya agar bersifat Pribadi (Private) atau dilindungi kata sandi?',
        answer: 'Saat ini, semua Bundle yang Anda buat di Synapse dirancang untuk akses Publik (Public) agar dapat diakses oleh semua followers Anda. Kami belum menyediakan fitur untuk mengatur Bundle menjadi Pribadi atau dilindungi kata sandi.',
    },
];
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="space-y-3 mb-12">
                        {filteredFaqs.length > 0 ? (
                            ...
                            <div className="bg-white rounded-xl p-12 text-center shadow-sm border border-gray-100">
                                ...
                                <h3 className="font-semibold text-gray-900 mb-2">Tidak ada hasil ditemukan</h3>
                    ...
                    <div className="bg-gradient-to-br from-purple-600 to-purple-400 rounded-2xl p-8 shadow-xl relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-purple-100 mb-6 text-lg">
                                Tim support Synapse siap membantu Anda 24/7. Hubungi kami untuk pertanyaan lebih lanjut atau bantuan teknis.
                            </p>
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 pb-8">
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                            ...
                            <a href="/tips" className="text-purple-600 text-sm font-medium hover:text-purple-700 flex items-center gap-1">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                            ...
                            <a href="/changelog" className="text-purple-600 text-sm font-medium hover:text-purple-700 flex items-center gap-1">
                                Lihat update
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                </svg>
